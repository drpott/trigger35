...
class SimpleTransport(transport.SSHClientTransport):
    ...
    def connectionSecure(self):
        self.requestService(SimpleUserAuth(self.factory.username, SimpleConnection()))
...
class CatChannel(channel.SSHChannel):
    ...
    def channelOpen(self, ignoredData):
        self.data = b''
        d = self.conn.sendRequest(self, 'exec', common.NS('get system info admin status'), wantReply = 1)
...
reactor.connectTCP(s, 22, factory)
reactor.run()
